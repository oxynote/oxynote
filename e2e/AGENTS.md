...
[AGENTS.md](../AGENTS.md). The testing standards below are the `web/`
standards ([web/AGENTS.md](../web/AGENTS.md)) carried over and adapted —
...
([docker/prod/](../docker/prod/AGENTS.md)), and adds the `prod-*.test.ts`
