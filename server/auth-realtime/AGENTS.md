...
live in [server/AGENTS.md](../AGENTS.md).
...
Read the document-storage section of [server/AGENTS.md](../AGENTS.md) before
...
`src/auth.ts`. See the "Database" section of [server/AGENTS.md](../AGENTS.md).
