...
// WithCancel creates a timeout-cancellable context if duration is
// greater than zero, if not, stadard cancellable context will be created.
func WithCancel(ctx context.Context, d timeutil.Duration) (context.Context, context.CancelFunc) {
	if d.Duration > 0 {
