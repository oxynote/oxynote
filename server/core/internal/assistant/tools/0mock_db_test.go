...
func (mock *DBMock) FetchMainBranchContent(ctx context.Context, docID xid.ID, organizationID string) (document.Content, error) {
	callInfo := struct {
		Ctx            context.Context
		DocID          xid.ID
		OrganizationID string
...
func (mock *DBMock) FetchMainBranchContentCalls() []struct {
	Ctx            context.Context
	DocID          xid.ID
	OrganizationID string
} {
