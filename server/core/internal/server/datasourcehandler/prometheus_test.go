...
func Test_Handler_FetchPrometheusDataSourceMetadata(t *testing.T) {
	...
	stubExec := func(cs processor.ConnectionStatus, result *processor.PrometheusMetadataResult, err error) *ExecutorMock {
		return &ExecutorMock{
			PrometheusMetadataFunc: func(_ context.Context, _ datasource.DataSource) (processor.ConnectionStatus, *processor.PrometheusMetadataResult, error) {
				return cs, result, err
			},
		}
	}
...
func Test_Handler_FetchPrometheusDataSourceLabelNames(t *testing.T) {
	...
	stubExec := func(cs processor.ConnectionStatus, result *processor.PrometheusLabelNamesResult, err error) *ExecutorMock {
		return &ExecutorMock{
			PrometheusLabelNamesFunc: func(_ context.Context, _ datasource.DataSource, _ []string, _ processor.TimeRange) (processor.ConnectionStatus, *processor.PrometheusLabelNamesResult, error) {
				return cs, result, err
			},
		}
	}
...
func Test_Handler_FetchPrometheusDataSourceLabelValues(t *testing.T) {
	...
	stubExec := func(cs processor.ConnectionStatus, result *processor.PrometheusLabelValuesResult, err error) *ExecutorMock {
		return &ExecutorMock{
			PrometheusLabelValuesFunc: func(_ context.Context, _ datasource.DataSource, _ string, _ []string, _ processor.TimeRange) (processor.ConnectionStatus, *processor.PrometheusLabelValuesResult, error) {
				return cs, result, err
			},
		}
	}
...
func Test_Handler_FetchPrometheusDataSourceSeries(t *testing.T) {
	...
	stubExec := func(cs processor.ConnectionStatus, result *processor.PrometheusSeriesResult, err error) *ExecutorMock {
		return &ExecutorMock{
			PrometheusSeriesFunc: func(_ context.Context, _ datasource.DataSource, _ []string, _ processor.TimeRange) (processor.ConnectionStatus, *processor.PrometheusSeriesResult, error) {
				return cs, result, err
			},
		}
	}
