...
async function deleteTag() {
	...
	await lastValidTarget.value.deleteTag()
	open.value = null
				...
				<div class="flex min-h-0 flex-col gap-3">
					<ShadcnUiDialogHeader>
						<ShadcnUiDialogTitle class="text-base">
							{{ $t("sidebar.tag-deletion-modal.title") }}
						</ShadcnUiDialogTitle>
						<ShadcnUiButton
							variant="ghost-plain"
					...
					<div class="flex flex-col gap-2 self-stretch">
						<ShadcnUiDialogDescription as-child class="text-2sm">
							<i18n-t
								scope="global"
								keypath="sidebar.tag-deletion-modal.description"
								tag="p"
							>
								<template #name>
					...
					<div class="flex gap-2 self-stretch">
						...
						>
							<Icon
								...
								class="size-3"
							/>
							{{ $t("sidebar.tag-deletion-modal.confirm-button") }}
						</ShadcnUiButton>
						<ShadcnUiButton
							type="button"
							size="sm"
							...
							@click="open = null"
						>
							{{ $t("sidebar.tag-deletion-modal.cancel-button") }}
						</ShadcnUiButton>
					</div>
				</div>
			</div>
